...
export const T: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    most_requested_title: "الأكثر طلبًا", most_requested_sub: "الفنادق التي تحظى بأكبر إقبال من ضيوفنا",
    ...
    error_required: "يرجى تعبئة الاسم ورقم الجوال وتاريخي الوصول والمغادرة.",
    error_dates: "يجب أن يكون تاريخ المغادرة بعد تاريخ الوصول.",
    ...
    options_room_types: "أنواع الغرف", options_amenities: "وسائل الراحة",
    options_empty: "لا توجد عناصر بعد.", options_delete_confirm: "هل تريد حذف هذا العنصر؟",
    featured_label: 'إضافة هذا الفندق ضمن "الأكثر طلبًا" في الصفحة الرئيسية',
    save_changes: "حفظ التعديلات", publish_hotel: "نشر الفندق على المنصة", add_option_btn: "إضافة خيار",
    hotel_error_required: "يرجى تعبئة الاسم والوصف بجميع اللغات الأربع، واختيار المدينة، وإدخال السعر وعدد الغرف.",
    hotel_error_positive: "يجب أن يكون السعر وعدد الغرف أكبر من صفر.",
    ...
    city_error_required: "يرجى إدخال اسم المدينة بجميع اللغات الأربع.",
  },
  en: {
    ...
    options_room_types: "Room types", options_amenities: "Amenities",
    options_empty: "No items yet.", options_delete_confirm: "Delete this item?",
    featured_label: 'Feature this hotel in "Most requested" on the homepage',
    save_changes: "Save changes", publish_hotel: "Publish hotel on the platform", add_option_btn: "Add option",
  ...
  tr: {
    ...
    options_room_types: "Oda tipleri", options_amenities: "Olanaklar",
    options_empty: "Henüz öğe yok.", options_delete_confirm: "Bu öğe silinsin mi?",
    featured_label: 'Bu oteli ana sayfada "En çok talep edilen" bölümünde göster',
    save_changes: "Değişiklikleri kaydet", publish_hotel: "Oteli platformda yayınla", add_option_btn: "Seçenek ekle",
  ...
  ur: {
    ...
    options_room_types: "کمروں کی اقسام", options_amenities: "سہولیات",
    options_empty: "ابھی کوئی آئٹم نہیں۔", options_delete_confirm: "کیا یہ آئٹم حذف کیا جائے؟",
    featured_label: 'اس ہوٹل کو ہوم پیج پر "سب سے زیادہ مطلوب" میں شامل کریں',
    save_changes: "تبدیلیاں محفوظ کریں", publish_hotel: "ہوٹل کو پلیٹ فارم پر شائع کریں", add_option_btn: "اختیار شامل کریں",
