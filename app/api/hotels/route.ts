...
async function parseHotelForm(request: Request) {
  ...
  if (ct.includes("multipart/form-data")) {
    ...
    return {
      ...
      checkInTimeAr: getStr("checkInTimeAr"),
      checkInTimeEn: getStr("checkInTimeEn"),
      checkInTimeTr: getStr("checkInTimeTr"),
      checkInTimeUr: getStr("checkInTimeUr"),
      checkOutTimeAr: getStr("checkOutTimeAr"),
      checkOutTimeEn: getStr("checkOutTimeEn"),
      checkOutTimeTr: getStr("checkOutTimeTr"),
      checkOutTimeUr: getStr("checkOutTimeUr"),
      featured,
    };
  }
  ...
  try {
    ...
    const [row] = await db
      ...
      .values({
        ...
        checkInTimeAr: data.checkInTimeAr ?? "",
        checkInTimeEn: data.checkInTimeEn ?? "",
        checkInTimeTr: data.checkInTimeTr ?? "",
        checkInTimeUr: data.checkInTimeUr ?? "",
        checkOutTimeAr: data.checkOutTimeAr ?? "",
        checkOutTimeEn: data.checkOutTimeEn ?? "",
        checkOutTimeTr: data.checkOutTimeTr ?? "",
        checkOutTimeUr: data.checkOutTimeUr ?? "",
