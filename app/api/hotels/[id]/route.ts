...
function rowToHotel(row: HotelJoined) {
  return {
    ...
    checkInTime: { ar: row.checkInTimeAr, en: row.checkInTimeEn, tr: row.checkInTimeTr, ur: row.checkInTimeUr },
    checkOutTime: { ar: row.checkOutTimeAr, en: row.checkOutTimeEn, tr: row.checkOutTimeTr, ur: row.checkOutTimeUr },
...
async function getHotelJoined(id: number): Promise<HotelJoined | null> {
  const rows = await db
    .select({
      ...
      checkInTimeAr: hotelsTable.checkInTimeAr,
      checkInTimeEn: hotelsTable.checkInTimeEn,
      checkInTimeTr: hotelsTable.checkInTimeTr,
      checkInTimeUr: hotelsTable.checkInTimeUr,
      checkOutTimeAr: hotelsTable.checkOutTimeAr,
      checkOutTimeEn: hotelsTable.checkOutTimeEn,
      checkOutTimeTr: hotelsTable.checkOutTimeTr,
      checkOutTimeUr: hotelsTable.checkOutTimeUr,
...
async function parseHotelForm(request: Request) {
  ...
  if (ct.includes("multipart/form-data")) {
    ...
    const result: Record<string, unknown> = {
      ...
      ...(fd.has("checkInTimeAr") && { checkInTimeAr: getStr("checkInTimeAr") }),
      ...(fd.has("checkInTimeEn") && { checkInTimeEn: getStr("checkInTimeEn") }),
      ...(fd.has("checkInTimeTr") && { checkInTimeTr: getStr("checkInTimeTr") }),
      ...(fd.has("checkInTimeUr") && { checkInTimeUr: getStr("checkInTimeUr") }),
      ...(fd.has("checkOutTimeAr") && { checkOutTimeAr: getStr("checkOutTimeAr") }),
      ...(fd.has("checkOutTimeEn") && { checkOutTimeEn: getStr("checkOutTimeEn") }),
      ...(fd.has("checkOutTimeTr") && { checkOutTimeTr: getStr("checkOutTimeTr") }),
      ...(fd.has("checkOutTimeUr") && { checkOutTimeUr: getStr("checkOutTimeUr") }),
  ...
  try {
    ...
    await db
      ...
      .set({
        ...
        ...(data.checkInTimeAr !== undefined && { checkInTimeAr: data.checkInTimeAr as string }),
        ...(data.checkInTimeEn !== undefined && { checkInTimeEn: data.checkInTimeEn as string }),
        ...(data.checkInTimeTr !== undefined && { checkInTimeTr: data.checkInTimeTr as string }),
        ...(data.checkInTimeUr !== undefined && { checkInTimeUr: data.checkInTimeUr as string }),
        ...(data.checkOutTimeAr !== undefined && { checkOutTimeAr: data.checkOutTimeAr as string }),
        ...(data.checkOutTimeEn !== undefined && { checkOutTimeEn: data.checkOutTimeEn as string }),
        ...(data.checkOutTimeTr !== undefined && { checkOutTimeTr: data.checkOutTimeTr as string }),
        ...(data.checkOutTimeUr !== undefined && { checkOutTimeUr: data.checkOutTimeUr as string }),
